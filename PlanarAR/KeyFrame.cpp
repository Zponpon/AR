...
double calcAngle(MyMatrix &R1, MyMatrix &R2)
{
	...
	R1Col2.x = R1.m_lpdEntries[2];
	R1Col2.y = R1.m_lpdEntries[5];
	R1Col2.z = R1.m_lpdEntries[8];
	R2Col2.x = R2.m_lpdEntries[2];
	R2Col2.y = R2.m_lpdEntries[5];
	R2Col2.z = R2.m_lpdEntries[8];

//	cout << "\nR1Col2 : " << R1Col2.x << ", " << R1Col2.y << ", " << R1Col2.z << endl;
//	cout << "R2Col2 : " << R2Col2.x << ", " << R2Col2.y << ", " << R2Col2.z;

	double Cosine = (R1Col2.x*R2Col2.x + R1Col2.y*R2Col2.y + R1Col2.z*R2Col2.z);
//	cout << "\nCosine : " << Cosine << endl;
